...
class SideNav extends React.Component
{
    renderItem(i = null)
    {
        ...
        return (
            <div className="dd-inner-container" key={this.props.items[i].id}>
                <a className="dd-container-link" href={i} onClick={(event) => { this.reveal(event) }}>
                    <div className="dd-container-title">{this.props.items[i].name}</div>
                    { children.length > 0 &&
                        <svg stroke="currentColor" fill="currentColor" stroke-width="0" viewBox="0 0 512 512" className="arrow" height="1em" width="1em" xmlns="http://www.w3.org/2000/svg"><path d="M294.1 256L167 129c-9.4-9.4-9.4-24.6 0-33.9s24.6-9.3 34 0L345 239c9.1 9.1 9.3 23.7.7 33.1L201.1 417c-4.7 4.7-10.9 7-17 7s-12.3-2.3-17-7c-9.4-9.4-9.4-24.6 0-33.9l127-127.1z"></path></svg>
                    }
                </a>
                { children.length > 0 &&
    ...
    reveal(e) {
        ...
        var child = e.target.closest('.dd-inner-container').querySelector('.dd-container-child');
